...
When you build HTTP applications with Drash, you start by creating a chain (specifically the [Request Chain](../modules/request-chain)). From there, you give it [resources](./resources). Resources are the classes you use to process requests and respond to those requests.
