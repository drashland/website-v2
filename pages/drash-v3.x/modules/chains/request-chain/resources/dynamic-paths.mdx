...
To learn more about handling path params, view the [Requests > Path Params](../requests/path-params) page.
...
- Learn how [resource groups](./resource-groups) can help you build prefixed resources, resources with middleware, and more
