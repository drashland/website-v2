...
!function (e, t) {
  ...
  var E = function (e) {
        ...
        if (11 !== T && (f = J.exec(e))) {
          if (o = f[1]) {
            if (9 === T) {
              ...
              m && (l = m.getElementById(o)) && x(t, l) && l.id === o
            ) return r.push(l), r;
          } else {
            if (f[2]) return L.apply(r, t.getElementsByTagName(e)), r;
            if (
              (o = f[3]) && n.getElementsByClassName && t.getElementsByClassName
    ...
    n = oe.support = {},
        ...
        return a !== d && 9 === a.nodeType && a.documentElement
          ? (d = a,
            ...
            (n.qsa = Q.test(d.querySelectorAll)) && (ue(function (e) {
              h.appendChild(e).innerHTML = "<a id='" + b +
                "'></a><select id='" + b +
            ...
            D = t
              ? function (e, t) {
                ...
                return r ||
                  (1 & (r = (e.ownerDocument || e) === (t.ownerDocument || t)
      ...
      oe.matchesSelector = function (e, t) {
        if (
          (e.ownerDocument || e) !== d && p(e),
            t = t.replace(z, "='$1']"),
            n.matchesSelector && g && !S[t + " "] && (!v || !v.test(t)) &&
            (!y || !y.test(t))
        ) {
          try {
            var r = m.call(e, t);
            if (
              r || n.disconnectedMatch ||
      ...
      oe.uniqueSort = function (e) {
        var t, r = [], i = 0, o = 0;
        if (
          f = !n.detectDuplicates, c = !n.sortStable && e.slice(0), e.sort(D), f
        ) {
      ...
      (r = oe.selectors = {
        ...
        filter: {
              ...
              : function (t, n, u) {
                ...
                if (y) {
                  ...
                  if (h = [a ? y.firstChild : y.lastChild], a && m) {
                    x =
                      (d =
                        (l = (c = (f = (p = y)[b] || (p[b] = {}))[p.uniqueID] ||
                            (f[p.uniqueID] = {}))[e] || [])[0] === T &&
                        l[1]) && l[2], p = d && y.childNodes[d];
          ...
          PSEUDO: function (e, t) {
            var n,
              i = r.pseudos[e] || r.setFilters[e.toLowerCase()] ||
    ...
    return s = oe.compile = function (e, t) {
      ...
      u = oe.select = function (e, t, n, i) {
        ...
        if (n = n || [], 1 === d.length) {
          if (
            (u = d[0] = d[0].slice(0)).length > 2 && "ID" === (l = u[0]).type &&
            ...
            return w.Deferred(function (t) {
              w.each(n, function (n, r) {
                ...
                o[r[1]](function () {
                  ...
                  e && g(e.promise)
                    ? e.promise().progress(t.notify).done(t.resolve).fail(
                      t.reject,
                    )
  ...
  w.extend({
    ...
    w.fn.extend({
      ...
      promise: function (e, t) {
        ...
        while (a--) {
          (n = J.get(o[a], e + "queueHooks")) && n.empty &&
            (r++, n.empty.add(s));
        }
  ...
  w.event = {
          ...
          while ((a = o.handlers[r++]) && !t.isImmediatePropagationStopped()) {
            t.rnamespace && !t.rnamespace.test(a.namespace) ||
              (t.handleObj = a,
                t.data = a.data,
                void 0 !==
                  (i = ((w.event.special[a.origType] || {}).handle || a.handler)
                    .apply(o.elem, u)) &&
                !1 === (t.result = i) &&
        ...
        for (; l !== this; l = l.parentNode || this) {
          if (1 === l.nodeType && ("click" !== e.type || !0 !== l.disabled)) {
            for (o = [], a = {}, n = 0; n < u; n++) {
              ...
              (a[i] = r.needsContext
                ? w(i, this).index(l) > -1
                : w.find(i, this, null, [l]).length), a[i] && o.push(r);
            }
    ...
    special: {
      ...
      click: {
        trigger: function () {
          if (
            "checkbox" === this.type && this.click && N(this, "input")
          ) return this.click(), !1;
        },
        _default: function (e) {
          return N(e.target, "a");
    ...
    if (
      ...
      if (u) {
        for (
          ...
          l = s[f],
            he.test(l.type || "") && !J.access(l, "globalEval") &&
            w.contains(c, l) &&
  ...
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        !(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType ||
          w.isXMLDoc(e))
      ) {
  ...
  function Fe(e, t, n) {
    ...
    return (n = n || $e(e)) &&
      ("" !== (a = n.getPropertyValue(t) || n[t]) ||
        w.contains(e.ownerDocument, e) || (a = w.style(e, t)),
  ...
  w.extend({
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        (n = ue(e, t, i), o = "number"),
          ...
          ("number" === o && (n += i && i[3] || (w.cssNumber[s] ? "" : "px")),
            h.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") ||
            (l[t] = "inherit"),
    ...
    css: function (e, t, n, r) {
      ...
      return Xe.test(t) || (t = Je(s)),
        (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a &&
        (i = a.get(e, !0, n)),
        void 0 === i && (i = Fe(e, t, r)),
    ...
    w.cssHooks.marginLeft = _e(h.reliableMarginLeft, function (e, t) {
      if (t) {
        return (parseFloat(Fe(e, "marginLeft")) ||
  ...
  w.Animation = w.extend(pt, {
    ...
    w.speed = function (e, t, n) {
      ...
      return w.fx.off
        ? r.duration = 0
        : "number" != typeof r.duration && (r.duration in w.fx.speeds
  ...
  w.fn.extend({
    ...
    w.each(w.expr.match.bool.source.match(/\w+/g), function (e, t) {
      ...
      ht[t] = function (e, t, r) {
        ...
        return r ||
          (o = ht[a], ht[a] = i, i = null != n(e, t, r) ? a : null, ht[a] = o),
          i;
      };
    });
              ...
              1 === this.nodeType &&
                (null == (i = r ? e.call(this, n, w(this).val()) : e)
                  ...
                  (t = w.valHooks[this.type] ||
                    ...
                    "set" in t && void 0 !== t.set(this, i, "value") ||
                  (this.value = i));
            });
        }
        if (i) {
          return (t = w.valHooks[i.type] ||
  ...
  w.extend(w.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        return t.type = m,
          o || t.isDefaultPrevented() ||
          d._default && !1 !== d._default.apply(v.pop(), n) || !Y(i) ||
          c && g(i[m]) && !y(i) &&
            ((u = i[c]) && (i[c] = null),
              w.event.triggered = m,
  ...
  w.extend({
    ...
    ajax: function (t, n) {
      ...
      if (
        h.data && h.processData && "string" != typeof h.data &&
        (h.data = w.param(h.data, h.traditional)),
          _t(It, h, n, E),
          c
      ) return E;
      (f = w.event && h.global) && 0 == w.active++ &&
      w.event.trigger("ajaxStart"),
        h.type = h.type.toUpperCase(),
        h.hasContent = !Mt.test(h.type),
        o = h.url.replace(Lt, ""),
        h.hasContent
          ? h.data && h.processData &&
            0 ===
  ...
  w.ajaxSetup({
    ...
    w.ajaxPrefilter("json jsonp", function (t, n, r) {
      var i,
        ...
        a,
        s = !1 !== t.jsonp &&
          (Qt.test(t.url) ? "url" : "string" == typeof t.data &&
            0 ===
      ...
      if (s || "jsonp" === t.dataTypes[0]) {
        return i = t.jsonpCallback = g(t.jsonpCallback)
          ? t.jsonpCallback()
          : t.jsonpCallback,
          s ? t[s] = t[s].replace(Qt, "$1" + i) : !1 !== t.jsonp &&
    ...
    w.fn.load = function (e, t, n) {
      ...
      return s > -1 && (r = vt(e.slice(s)), e = e.slice(0, s)),
        ...
        a.length > 0 &&
        w.ajax({ url: e, type: i || "GET", dataType: "html", data: t }).done(
          function (e) {
            o = arguments,
