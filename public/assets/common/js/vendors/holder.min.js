  ...
  function (e, t) {
    ...
    return function (e) {
      ...
      (function (t) {
          ...
          if (
            ...
            if (
              s.bg && (n.theme.bg = w.parseColor(s.bg)),
                ...
                s.theme && n.instanceOptions.themes.hasOwnProperty(s.theme) &&
              ...
              F.vars.cache.themeKeys = F.vars.cache.themeKeys ||
                Object.keys(n.instanceOptions.themes);
              var l = F.vars.cache
                .themeKeys[0 | Math.random() * F.vars.cache.themeKeys.length];
        ...
        function o(e) {
          ...
          if (
            r.font &&
            (s.font = r.font,
              !v.noFontFallback && "img" === n.nodeName.toLowerCase() &&
              F.setup.supportsCanvas && "svg" === v.renderer &&
            ...
            : "fluid" == t &&
              (n.holderData.resizeUpdate = !0,
                ...
                "%" == o.width.slice(-1)
                  ...
                  : null != r.auto && r.auto ||
                    (n.style.width = o.width + "px"),
                ("inline" == n.style.display || "" === n.style.display ||
        ...
        function s(e) {
          ...
          switch (
            ...
            case "literal":
              e.text = e.flags.dimensions.width + "x" +
                e.flags.dimensions.height;
              break;
            case "exact":
              if (!e.flags.exactDimensions) break;
              e.text = Math.floor(e.flags.exactDimensions.width) + "x" +
          ...
          for (var n = 0, r = t.length; r > n; n++) {
            ...
            if (i.holderData) {
              ...
              if (s) {
                ...
                "exact" == o.textmode &&
                (o.exactDimensions = s,
                  h.holderSettings.dimensions = o.dimensions), a(h);
              } else f(i);
            }
          }
        }
          ...
          if (e.holderData) {
            ...
            if (t) {
              ...
              r.fluidWidth && !r.fluidHeight
                ? (r.mode = "width",
                  r.ratio = r.initialDimensions.width /
                    parseFloat(n.dimensions.height))
                : !r.fluidWidth && r.fluidHeight &&
                  (r.mode = "height",
                    r.ratio = parseFloat(n.dimensions.width) /
        ...
        function d() {
          ...
          r.forEach(function (t) {
            e = F.vars.invisibleImages[t],
              k(e) && "img" == e.nodeName.toLowerCase() &&
        ...
        function c() {
          F.vars.visibilityCheckStarted ||
            (t.requestAnimationFrame(d), F.vars.visibilityCheckStarted = !0);
        }
        function f(e) {
        ...
        var m = n(2),
          ...
          O = {
            ...
            addTheme: function (e, t) {
              return null != e && null != t && (F.settings.themes[e] = t),
            ...
            run: function (e) {
              ...
              return n.stylesheets = [],
                ...
                h.forEach(function (e) {
                  if (
                    e.attributes.rel && e.attributes.href &&
                ...
                l.forEach(function (e) {
                  if (t.getComputedStyle) {
                    var r = t.getComputedStyle(e, null).getPropertyValue(
                        "background-image",
                      ),
                ...
                s.forEach(function (e) {
                  ...
                  o
                    ? 0 === t.src.indexOf(a.domain) ? r(a, n, t.src, e) : s &&
                      (l ? r(a, n, t.dataSrc, e) : !function (e, t, n, i, o) {
        ...
        for (var D in F.flags) {
          F.flags.hasOwnProperty(D) && (F.flags[D].match = function (e) {
            ...
            if (e.document) {
              ...
              if (r.getContext) {
                ...
                t = e.devicePixelRatio || 1,
                  n = i.webkitBackingStorePixelRatio ||
                    i.mozBackingStorePixelRatio || i.msBackingStorePixelRatio ||
      ...
      e.exports = function (e, t) {
        ...
        var v = d.element({ tag: "g", content: m }), y = null;
      ...
      e.exports = function r(e, t, n) {
        ...
        function i(e) {
          var t = e.match(/^\w+/),
            ...
            o = e.match(/\$([\w-]+)/),
            a = e.match(/\.[\w-]+/g);
          return i && (r.attr.id = i[1], n[i[1]] = r),
            o && (n[o[1]] = r),
        ...
        function o(e, t) {
          return null !== t && t !== !1 && void 0 !== t
            ? "string" != typeof t && "object" != typeof t ? String(t) : t
            : void 0;
        }
        function a(e) {
        ...
        for (; c < e.length; c++) {
          ...
          if (void 0 !== e[c] && e[c] !== !0) {
            if ("string" == typeof e[c]) {
              ...
              for (h in e[c]) {
                e[c].hasOwnProperty(h) && null !== e[c][h] && e[c][h] !== !1 &&
                  ("style" === h && "object" == typeof e[c][h]
                    ? e[0].attr[h] = JSON.stringify(e[c][h], o).slice(2, -2)
                      .replace(/","/g, ";").replace(/":"/g, ":").replace(
                        /\\"/g,
                        "'",
                      )
      ...
      e.exports = function () {
        ...
        return function (n) {
          ...
          t.font = d.properties.font.weight + " " + r * d.properties.font.size +
            d.properties.font.units + " " + d.properties.font.family +
            ", monospace", t.fillStyle = d.properties.fill;
