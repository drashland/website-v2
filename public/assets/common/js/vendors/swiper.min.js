...
!function (e, t) {
    ...
    on: function () {
      ...
      function o(e) {
        ...
        if (t) {
          ...
          else {for (var i = L(t).parents(), s = 0; s < i.length; s += 1) {
  ...
  var e,
      ...
      getTranslate: function (e, t) {
        ...
        return B.WebKitCSSMatrix
          ...
          : a = (s = r.MozTransform || r.OTransform || r.MsTransform ||
            r.msTransform || r.transform ||
            r.getPropertyValue("transform").replace(
              "translate(",
              "matrix(1, 0, 0, 1,",
            )).toString().split(","),
          "x" === t &&
    ...
    Y = (i = f.createElement("div"), {
      touch: B.Modernizr && !0 === B.Modernizr.touch ||
        !!("ontouchstart" in B ||
      ...
      transition: (a = i.style,
        "transition" in a || "webkitTransition" in a ||
        "MozTransition" in a),
      transforms3d: B.Modernizr && !0 === B.Modernizr.csstransforms3d ||
        (e = i.style,
          "webkitPerspective" in e || "MozPerspective" in e ||
  ...
  var o = {
    updateSize: function () {
      ...
      e = void 0 !== a.params.width ? a.params.width : i[0].clientWidth,
        ...
        (e = e - parseInt(i.css("padding-left"), 10) -
          parseInt(i.css("padding-right"), 10),
          t = t - parseInt(i.css("padding-top"), 10) -
      ...
      if (void 0 !== i) {
        ...
        for (
          ...
          if (1 < t.slidesPerColumn) {
            ...
            "column" === t.slidesPerColumnFill
              ...
              ).attr("data-swiper-column", $).attr("data-swiper-row", L);
          }
        ...
        if (
          e.virtualSize = Math.max(e.virtualSize, i) + v,
            s && r && ("slide" === t.effect || "coverflow" === t.effect) &&
            ...
            (e.virtualSize = (E + t.spaceBetween) * x,
              e.virtualSize = Math.ceil(e.virtualSize / t.slidesPerColumn) -
                t.spaceBetween,
              e.isHorizontal()
                ? a.css({ width: e.virtualSize + t.spaceBetween + "px" })
                : a.css({ height: e.virtualSize + t.spaceBetween + "px" }),
        ...
        for (var n = 0; n < i.length; n += 1) {
          ...
          if (a.watchSlidesVisibility) {
            ...
            (0 <= d && d < t.size || 0 < p && p <= t.size ||
              d <= 0 && p >= t.size) && i.eq(n).addClass(a.slideVisibleClass);
          }
          o.progress = s ? -l : l;
        }
      }
    ...
    updateClickedSlide: function (e) {
      ...
      t.clickedSlide = i,
        ...
        a.slideToClickedSlide && void 0 !== t.clickedIndex &&
  ...
  var h = {
    setGrabCursor: function (e) {
      if (
        !(Y.touch || !this.params.simulateTouch ||
    ...
    m = function () {
      ...
      if (
        a && (t.os = "windows", t.osVersion = a[2], t.windows = !0),
          ...
          r &&
          (t.osVersion = r[3] ? r[3].replace(/_/g, ".") : null, t.iphone = !0),
          t.ios && t.osVersion && 0 <= e.indexOf("Version/") &&
    ...
    if (!a || 0 !== a.offsetWidth) {
      ...
      if (
        ...
        e.setTranslate(n),
          ...
          ("auto" === t.slidesPerView || 1 < t.slidesPerView) && e.isEnd &&
  ...
  var b = {
    attachEvents: function () {
      ...
      e.onTouchStart = function (e) {
        ...
        if (!t.animating || !i.preventInteractionOnTransition) {
          ...
          if (
            ...
            if (
              i.noSwiping && L(r.target).closest(
                i.noSwipingSelector
                  ? i.noSwipingSelector
                  : "." + i.noSwipingClass,
              )[0]
              ...
              if (!l || !(n <= d || n >= B.screen.width - d)) {
                if (
                  ...
                  L(r.target).is(a.formElements) && (p = !1),
                    f.activeElement && L(f.activeElement).is(a.formElements) &&
                    f.activeElement !== r.target && f.activeElement.blur(),
        ...
        e.onTouchMove = function (e) {
          ...
          if (n.originalEvent && (n = n.originalEvent), a.isTouched) {
            if (!a.isTouchEvent || "mousemove" !== n.type) {
              ...
              if (
                ...
                n.target === f.activeElement && L(n.target).is(a.formElements)
              ...
              if (
                ...
                if (
                  ...
                  if (
                    ...
                    t.allowClick = !1,
                      n.preventDefault(),
                      i.touchMoveStopPropagation && !i.nested &&
                      n.stopPropagation(),
                      a.isMoved ||
                      (i.loop && t.loopFix(),
                    ...
                    if (
                      i.touchReleaseOnEdges && (v = 0),
                        ...
                        !t.allowSlideNext && "next" === t.swipeDirection &&
                        a.currentTranslate < a.startTranslate &&
                        (a.currentTranslate = a.startTranslate),
                        !t.allowSlidePrev && "prev" === t.swipeDirection &&
                        a.currentTranslate > a.startTranslate &&
                        (a.currentTranslate = a.startTranslate),
                        0 < i.threshold
                    ) {
          ...
          } else {a.startMoving && a.isScrolling &&
        ...
        e.onTouchEnd = function (e) {
          ...
          if (
            ...
            if (i.freeModeMomentum) {
              ...
              if (
                x && t.once("transitionEnd", function () {
                  t.loopFix();
                }), 0 !== t.velocity
              ) {
                g = r
      ...
      if (Y.touch || !Y.pointerEvents && !Y.prefixedPointerEvents) {
        if (Y.touch) {
          var o = !("touchstart" !== a.start || !Y.passiveListener ||
            !t.passiveListeners) && { passive: !0, capture: !1 };
    ...
    detachEvents: function () {
      ...
      if (Y.touch || !Y.pointerEvents && !Y.prefixedPointerEvents) {
        if (Y.touch) {
          var o = !("onTouchStart" !== a.start || !Y.passiveListener ||
            !t.passiveListeners) && { passive: !0, capture: !1 };
  ...
  var w,
    ...
    I = {
      isIE: !!B.navigator.userAgent.match(/Trident/g) ||
        !!B.navigator.userAgent.match(/MSIE/g),
      isSafari:
        (w = B.navigator.userAgent.toLowerCase(),
          0 <= w.indexOf("safari") && w.indexOf("chrome") < 0 &&
          w.indexOf("android") < 0),
      ...
      classes: {
        addClasses: function () {
          ...
          s.push(a.direction),
            ...
            m.ios && s.push("ios"),
            I.isIE && (Y.pointerEvents || Y.prefixedPointerEvents) &&
        ...
        void 0 === r.modules && (r.modules = {}),
          Object.keys(r.modules).forEach(function (e) {
            ...
            if (t.params) {
              ...
              !0 === s[a] && (s[a] = { enabled: !0 }),
                "object" != typeof s[a] || "enabled" in s[a] ||
                (s[a].enabled = !0),
                s[a] || (s[a] = { enabled: !1 });
            }
          });
            ...
            t.breakpoints && a.setBreakpoint(),
              ...
              a.params.freeMode
                ...
                : (("auto" === a.params.slidesPerView ||
                    ...
                    a.isEnd && !a.params.centeredSlides
            ...
            (a.emit("beforeDestroy"),
              ...
              (a.removeClasses(),
                ...
                n.removeClass(
                  ...
                  .removeAttr("data-swiper-column").removeAttr(
                    "data-swiper-row",
                  )),
              a.emit("destroy"),
      ...
      handle: function (e) {
        ...
        if (
          ...
          if (
            ...
            for (
              var d = [[l.left, l.top], [l.left + t.width, l.top], [
                  l.left,
                  l.top + t.height,
  ...
  var G = {
      ...
      event: -1 < B.navigator.userAgent.indexOf("firefox")
        ? "DOMMouseScroll"
        : (function () {
      ...
      handle: function (e) {
        ...
        } else {s = Math.abs(n.pixelX) > Math.abs(n.pixelY)
            ? -n.pixelX * r
            : -n.pixelY;}
        if (0 === s) return !0;
    ...
    N = {
      ...
      init: function () {
        ...
        (i.nextEl || i.prevEl) &&
          (i.nextEl &&
            (e = L(i.nextEl),
              a.params.uniqueNavElements && "string" == typeof i.nextEl &&
              1 < e.length && 1 === a.$el.find(i.nextEl).length &&
              (e = a.$el.find(i.nextEl))),
            i.prevEl &&
            (t = L(i.prevEl),
              a.params.uniqueNavElements && "string" == typeof i.prevEl &&
              1 < t.length && 1 === a.$el.find(i.prevEl).length &&
        ...
        if (
          ...
          if (
            e.params.loop
              ...
              "bullets" === s.type && e.pagination.bullets &&
              0 < e.pagination.bullets.length
          ) {
            var o, l, d, p = e.pagination.bullets;
            if (
              s.dynamicBullets &&
              (e.pagination.bulletSize = p.eq(0)
                ...
                d = ((l = o + (Math.min(p.length, s.dynamicMainBullets) - 1)) +
                  o) / 2),
                p.removeClass(
                  s.bulletActiveClass + " " + s.bulletActiveClass + "-next " +
                    s.bulletActiveClass + "-next-next " + s.bulletActiveClass +
                    "-prev " + s.bulletActiveClass + "-prev-prev " +
              ...
              p.each(function (e, t) {
                ...
                i === r && a.addClass(s.bulletActiveClass),
                  ...
                  (o <= i && i <= l &&
                    ...
                    i === o &&
                    a.prev().addClass(s.bulletActiveClass + "-prev").prev()
                      .addClass(s.bulletActiveClass + "-prev-prev"),
                    i === l &&
                    a.next().addClass(s.bulletActiveClass + "-next").next()
              ...
              c.prev().addClass(s.bulletActiveClass + "-prev").prev().addClass(
                ...
                u.next().addClass(s.bulletActiveClass + "-next").next()
                  .addClass(s.bulletActiveClass + "-next-next");
            }
            if (s.dynamicBullets) {
        ...
        if (e.el) {
          ...
          0 !== t.length &&
            (a.params.uniqueNavElements && "string" == typeof e.el &&
              1 < t.length && 1 === a.$el.find(e.el).length &&
              (t = a.$el.find(e.el)),
              ...
              "progressbar" === e.type && e.progressbarOpposite &&
    ...
    R = {
      ...
      setDragPosition: function (e) {
        ...
        t = ((a.isHorizontal()
          ...
          : e.pageY || e.clientY) -
          r.offset()[a.isHorizontal() ? "left" : "top"] - n / 2) / (o - n),
      ...
      init: function () {
        ...
        if (e.params.scrollbar.el) {
          ...
          e.params.uniqueNavElements && "string" == typeof i.el &&
            1 < s.length && 1 === a.find(i.el).length && (s = a.find(i.el));
          var r = s.find("." + e.params.scrollbar.dragClass);
          0 === r.length &&
          (r = L('<div class="' + e.params.scrollbar.dragClass + '"></div>'),
            s.append(r)),
    ...
    W = {
        ...
        if (
          ...
          if (!(n < i.slideWidth && o < i.slideHeight)) {
            ...
            e.preventDefault(),
              ...
              r.x = (s.touchesCurrent.x - r.prevPositionX) /
                (Date.now() - r.prevTime) / 2,
              r.y = (s.touchesCurrent.y - r.prevPositionY) /
                (Date.now() - r.prevTime) / 2,
      ...
      enable: function () {
        ...
        if (!t.enabled) {
          t.enabled = !0;
          var a =
            !("touchstart" !== e.touchEvents.start || !Y.passiveListener ||
    ...
    q = {
      loadInSlide: function (e, l) {
        ...
        if (void 0 !== e && 0 !== d.slides.length) {
          ...
          c.hasClass(p.loadingClass) || (t = t.add(c[0])),
    ...
    K = {
      ...
      onEnterKey: function (e) {
        ...
        if (13 === e.keyCode) {
          ...
          (t.isEnd && !t.params.loop || t.slideNext(),
            ...
            t.navigation && t.navigation.$prevEl &&
      ...
      destroy: function () {
        ...
        a.a11y.liveRegion.remove(),
          ...
          a.pagination && a.params.pagination.clickable &&
          a.pagination.bullets && a.pagination.bullets.length &&
          a.pagination.$el.off(
            "keydown",
    ...
    _ = {
      ...
      setHash: function () {
        ...
        if (e.hashNavigation.initialized && e.params.hashNavigation.enabled) {
          if (
            e.params.hashNavigation.replaceState && B.history &&
    ...
    J = {
      setTranslate: function () {
        ...
        for (var h = 0; h < s.length; h += 1) {
          ...
          f % 4 == 0
            ...
            o && (w = -w),
            p || (y = w, w = 0);
          var E = "rotateX(" + (p ? 0 : -m) + "deg) rotateY(" + (p ? m : 0) +
        ...
        if (
          ...
          if (p) {
            ...
            var C = Math.abs(u) - 90 * Math.floor(Math.abs(u) / 90),
              ...
              P = d.shadowOffset;
            e.transform(
              "scale3d(" + z + ", 1, " + k + ") translate3d(0px, " +
                (n / 2 + P) + "px, " + -n / 2 / k + "px) rotateX(-90deg)",
            );
          }
        }
      ...
      setTransition: function (e) {
        ...
        this.slides.transition(e).find(
          ...
          this.params.cubeEffect.shadow && !this.isHorizontal() &&
          ...
          if (
            ...
            (p = L(
              '<div class="swiper-slide-shadow-' +
                (e.isHorizontal() ? "left" : "top") + '"></div>',
            ),
              s.append(p)),
              0 === c.length &&
              (c = L(
                '<div class="swiper-slide-shadow-' +
                  (e.isHorizontal() ? "right" : "bottom") + '"></div>',
              ),
                s.append(c)),
      ...
      setTranslate: function () {
        for (
          ...
          Math.abs(x) < .001 && (x = 0),
            ...
            Math.abs(g) < .001 && (g = 0),
            Math.abs(b) < .001 && (b = 0);
          var E = "translate3d(" + x + "px," + y + "px," + w + "px)  rotateX(" +
            b + "deg) rotateY(" + g + "deg)";
          if (
            v.transform(E),
      ...
      on: {
        ...
        doubleTap: function (e) {
          this.params.zoom.enabled && this.zoom.enabled &&
            this.params.zoom.toggle && this.zoom.toggle(e);
        },
      ...
      on: {
        ...
        init: function () {
          this.params.lazy.enabled && !this.params.loop &&
            0 === this.params.initialSlide && this.lazy.load();
        },
        scroll: function () {
