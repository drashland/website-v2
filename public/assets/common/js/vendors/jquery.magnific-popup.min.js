  ...
  t.prototype = {
    ...
    init: function () {
      ...
      b.isLowIE = b.isIE8 = document.all && !document.addEventListener,
        ...
        b.probablyMobile = b.isAndroid || b.isIOS ||
    ...
    parseEl: function (c) {
      ...
      if (
        e.tagName
          ? e = { el: a(e) }
          : (d = e.type, e = { data: e, src: e.src }), e.el
      ) {
    ...
    _checkIfClose: function (c) {
      if (!a(c).hasClass(s)) {
        ...
        if (d && e) return !0;
        if (
          !b.content || a(c).hasClass("mfp-close") ||
          ...
          if (e = c.split("_"), e.length > 1) {
            ...
            if (f.length > 0) {
              ...
              "replaceWith" === g
                ...
                : "img" === g
                ? f.is("img") ? f.attr("src", d) : f.replaceWith(
        ...
        if (G(), c.src) {
          ...
          if (f.length) {
            ...
            (D || (C = e.hiddenClass, D = x(C), C = "mfp-" + C),
              E = f.after(D).detach().removeClass(C)), b.updateStatus("ready");
  ...
  a.magnificPopup.registerModule("zoom", {
    ...
    proto: {
      ...
      _getOffset: function (c) {
        ...
        return O()
          ? h["-moz-transform"] = h.transform = "translate(" + e.left + "px," +
            e.top + "px)"
            ...
            ? (f += " mfp-gallery",
              ...
              w("BuildControls" + e, function () {
                if (b.items.length > 1 && c.arrows && !b.arrowLeft) {
                  var d = c.arrowMarkup,
                    e = b.arrowLeft = a(
                      d.replace(/%title%/gi, c.tPrev).replace(
                        /%dir%/gi,
                        "left",
                      ),
                    ).addClass(s),
                    f = b.arrowRight = a(
                      d.replace(/%title%/gi, c.tNext).replace(
                        /%dir%/gi,
                        "right",
                      ),
                    ).addClass(s);
